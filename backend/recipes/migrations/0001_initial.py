# Generated by Django 4.2.7 on 2024-04-16 17:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Минимальное время приготовления 1 минута.'), django.core.validators.MaxValueValidator(10000, message='Максимальное время приготовления 32000 минут.')], verbose_name='Время приготовления')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Минимальное количество ингредиентов 1!'), django.core.validators.MaxValueValidator(64, message='Максимальное количество ингредиентов 32000!')], verbose_name='Кол-во')),
